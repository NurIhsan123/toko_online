		...
		<div class="card-body">
			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="form-group">
						<label>Harga</label>
						<input type="number" name="harga" min="0" class="form-control" placeholder="harga barang" value="<?= set_value('harga') ?>">
					</div>
				</div>
				<div class="col-sm-4">
					<div class="form-group">
						<label>Berat (Gr)</label>
						<input type="number" name="berat" min="0" class="form-control" placeholder="Berat Dalam Gram" value="<?= set_value('berat') ?>">
					</div>
				</div>
			</div>
