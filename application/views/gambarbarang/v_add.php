			...
			<div class="row">
				<?php foreach ($gambar as $key => $value) { ?>
					<div class="col-sm-3">
						...
						<button data-toggle="modal" data-target="#delete<?= $value->id_gambar ?>" class="btn btn-danger btn-sm btn-block"><i class="fas fa-trash"></i> Delete</button>
					</div>
				<?php	} ?>
...
<h4>Apakah anda yakin ingin gambar ini?</h4>
